											...
											BEGIN
												...
												IF @VP_N_SALIDA_PIEL_MHI > 0
													BEGIN
														...
														-- UPDATE PACKING
														UPDATE	@VP_SALIDA_PIEL_MHI_TBL 	
															SET	DIA_1	= 	( CASE WHEN @VP_DIA = '01' THEN ( CASE WHEN DIA_1 = '' OR DIA_1 = @VP_PACKING_NO THEN @VP_PACKING_NO WHEN DIA_1 LIKE '%' + @VP_PACKING_NO + '%' THEN DIA_1 ELSE CONCAT(DIA_1,'/', @VP_PACKING_NO) END) ELSE DIA_1 END ), 
																DIA_2	= 	( CASE WHEN @VP_DIA = '02' THEN ( CASE WHEN DIA_2 = '' OR DIA_2 = @VP_PACKING_NO THEN @VP_PACKING_NO WHEN DIA_2 LIKE '%' + @VP_PACKING_NO + '%' THEN DIA_2 ELSE CONCAT(DIA_2,'/', @VP_PACKING_NO) END) ELSE DIA_2 END ),  
																DIA_3	= 	( CASE WHEN @VP_DIA = '03' THEN ( CASE WHEN DIA_3 = '' OR DIA_3 = @VP_PACKING_NO THEN @VP_PACKING_NO WHEN DIA_3 LIKE '%' + @VP_PACKING_NO + '%' THEN DIA_3 ELSE CONCAT(DIA_3,'/', @VP_PACKING_NO) END) ELSE DIA_3 END ),  
																DIA_4	= 	( CASE WHEN @VP_DIA = '04' THEN ( CASE WHEN DIA_4 = '' OR DIA_4 = @VP_PACKING_NO THEN @VP_PACKING_NO WHEN DIA_4 LIKE '%' + @VP_PACKING_NO + '%' THEN DIA_4 ELSE CONCAT(DIA_4,'/', @VP_PACKING_NO) END) ELSE DIA_4 END ),  
																DIA_5	= 	( CASE WHEN @VP_DIA = '05' THEN ( CASE WHEN DIA_5 = '' OR DIA_5 = @VP_PACKING_NO THEN @VP_PACKING_NO WHEN DIA_5 LIKE '%' + @VP_PACKING_NO + '%' THEN DIA_5 ELSE CONCAT(DIA_5,'/', @VP_PACKING_NO) END) ELSE DIA_5 END ),  
																DIA_6	= 	( CASE WHEN @VP_DIA = '06' THEN ( CASE WHEN DIA_6 = '' OR DIA_6 = @VP_PACKING_NO THEN @VP_PACKING_NO WHEN DIA_6 LIKE '%' + @VP_PACKING_NO + '%' THEN DIA_6 ELSE CONCAT(DIA_6,'/', @VP_PACKING_NO) END) ELSE DIA_6 END ),  
																DIA_7	= 	( CASE WHEN @VP_DIA = '07' THEN ( CASE WHEN DIA_7 = '' OR DIA_7 = @VP_PACKING_NO THEN @VP_PACKING_NO WHEN DIA_7 LIKE '%' + @VP_PACKING_NO + '%' THEN DIA_7 ELSE CONCAT(DIA_7,'/', @VP_PACKING_NO) END) ELSE DIA_7 END ),  
																DIA_8	= 	( CASE WHEN @VP_DIA = '08' THEN ( CASE WHEN DIA_8 = '' OR DIA_8 = @VP_PACKING_NO THEN @VP_PACKING_NO WHEN DIA_8 LIKE '%' + @VP_PACKING_NO + '%' THEN DIA_8 ELSE CONCAT(DIA_8,'/', @VP_PACKING_NO) END) ELSE DIA_8 END ),  
																DIA_9	= 	( CASE WHEN @VP_DIA = '09' THEN ( CASE WHEN DIA_9 = '' OR DIA_9 = @VP_PACKING_NO THEN @VP_PACKING_NO WHEN DIA_9 LIKE '%' + @VP_PACKING_NO + '%' THEN DIA_9 ELSE CONCAT(DIA_9,'/', @VP_PACKING_NO) END) ELSE DIA_9 END ),  
																DIA_10	= 	( CASE WHEN @VP_DIA = '10' THEN ( CASE WHEN DIA_10 = '' OR DIA_10 = @VP_PACKING_NO THEN @VP_PACKING_NO WHEN DIA_10 LIKE '%' + @VP_PACKING_NO + '%' THEN DIA_10 ELSE CONCAT(DIA_10,'/', @VP_PACKING_NO) END) ELSE DIA_10 END ),	
																DIA_11	= 	( CASE WHEN @VP_DIA = '11' THEN ( CASE WHEN DIA_11 = '' OR DIA_11 = @VP_PACKING_NO THEN @VP_PACKING_NO WHEN DIA_11 LIKE '%' + @VP_PACKING_NO + '%' THEN DIA_11 ELSE CONCAT(DIA_11,'/', @VP_PACKING_NO) END) ELSE DIA_11 END ),	 
																DIA_12	= 	( CASE WHEN @VP_DIA = '12' THEN ( CASE WHEN DIA_12 = '' OR DIA_12 = @VP_PACKING_NO THEN @VP_PACKING_NO WHEN DIA_12 LIKE '%' + @VP_PACKING_NO + '%' THEN DIA_12 ELSE CONCAT(DIA_12,'/', @VP_PACKING_NO) END) ELSE DIA_12 END ),	 
																DIA_13	= 	( CASE WHEN @VP_DIA = '13' THEN ( CASE WHEN DIA_13 = '' OR DIA_13 = @VP_PACKING_NO THEN @VP_PACKING_NO WHEN DIA_13 LIKE '%' + @VP_PACKING_NO + '%' THEN DIA_13 ELSE CONCAT(DIA_13,'/', @VP_PACKING_NO) END) ELSE DIA_13 END ),	 
																DIA_14	= 	( CASE WHEN @VP_DIA = '14' THEN ( CASE WHEN DIA_14 = '' OR DIA_14 = @VP_PACKING_NO THEN @VP_PACKING_NO WHEN DIA_14 LIKE '%' + @VP_PACKING_NO + '%' THEN DIA_14 ELSE CONCAT(DIA_14,'/', @VP_PACKING_NO) END) ELSE DIA_14 END ),	 
																DIA_15	= 	( CASE WHEN @VP_DIA = '15' THEN ( CASE WHEN DIA_15 = '' OR DIA_15 = @VP_PACKING_NO THEN @VP_PACKING_NO WHEN DIA_15 LIKE '%' + @VP_PACKING_NO + '%' THEN DIA_15 ELSE CONCAT(DIA_15,'/', @VP_PACKING_NO) END) ELSE DIA_15 END ),	 
																DIA_16	= 	( CASE WHEN @VP_DIA = '16' THEN ( CASE WHEN DIA_16 = '' OR DIA_16 = @VP_PACKING_NO THEN @VP_PACKING_NO WHEN DIA_16 LIKE '%' + @VP_PACKING_NO + '%' THEN DIA_16 ELSE CONCAT(DIA_16,'/', @VP_PACKING_NO) END) ELSE DIA_16 END ),	 
																DIA_17	= 	( CASE WHEN @VP_DIA = '17' THEN ( CASE WHEN DIA_17 = '' OR DIA_17 = @VP_PACKING_NO THEN @VP_PACKING_NO WHEN DIA_17 LIKE '%' + @VP_PACKING_NO + '%' THEN DIA_17 ELSE CONCAT(DIA_17,'/', @VP_PACKING_NO) END) ELSE DIA_17 END ),	 
																DIA_18	= 	( CASE WHEN @VP_DIA = '18' THEN ( CASE WHEN DIA_18 = '' OR DIA_18 = @VP_PACKING_NO THEN @VP_PACKING_NO WHEN DIA_18 LIKE '%' + @VP_PACKING_NO + '%' THEN DIA_18 ELSE CONCAT(DIA_18,'/', @VP_PACKING_NO) END) ELSE DIA_18 END ),	 
																DIA_19	= 	( CASE WHEN @VP_DIA = '19' THEN ( CASE WHEN DIA_19 = '' OR DIA_19 = @VP_PACKING_NO THEN @VP_PACKING_NO WHEN DIA_19 LIKE '%' + @VP_PACKING_NO + '%' THEN DIA_19 ELSE CONCAT(DIA_19,'/', @VP_PACKING_NO) END) ELSE DIA_19 END ),	 
																DIA_20	= 	( CASE WHEN @VP_DIA = '20' THEN ( CASE WHEN DIA_20 = '' OR DIA_20 = @VP_PACKING_NO THEN @VP_PACKING_NO WHEN DIA_20 LIKE '%' + @VP_PACKING_NO + '%' THEN DIA_20 ELSE CONCAT(DIA_20,'/', @VP_PACKING_NO) END) ELSE DIA_20 END ),
																DIA_21	= 	( CASE WHEN @VP_DIA = '21' THEN ( CASE WHEN DIA_21 = '' OR DIA_21 = @VP_PACKING_NO THEN @VP_PACKING_NO WHEN DIA_21 LIKE '%' + @VP_PACKING_NO + '%' THEN DIA_21 ELSE CONCAT(DIA_21,'/', @VP_PACKING_NO) END) ELSE DIA_21 END ), 
																DIA_22	= 	( CASE WHEN @VP_DIA = '22' THEN ( CASE WHEN DIA_22 = '' OR DIA_22 = @VP_PACKING_NO THEN @VP_PACKING_NO WHEN DIA_22 LIKE '%' + @VP_PACKING_NO + '%' THEN DIA_22 ELSE CONCAT(DIA_22,'/', @VP_PACKING_NO) END) ELSE DIA_22 END ), 
																DIA_23	= 	( CASE WHEN @VP_DIA = '23' THEN ( CASE WHEN DIA_23 = '' OR DIA_23 = @VP_PACKING_NO THEN @VP_PACKING_NO WHEN DIA_23 LIKE '%' + @VP_PACKING_NO + '%' THEN DIA_23 ELSE CONCAT(DIA_23,'/', @VP_PACKING_NO) END) ELSE DIA_23 END ), 
																DIA_24	= 	( CASE WHEN @VP_DIA = '24' THEN ( CASE WHEN DIA_24 = '' OR DIA_24 = @VP_PACKING_NO THEN @VP_PACKING_NO WHEN DIA_24 LIKE '%' + @VP_PACKING_NO + '%' THEN DIA_24 ELSE CONCAT(DIA_24,'/', @VP_PACKING_NO) END) ELSE DIA_24 END ), 
																DIA_25	= 	( CASE WHEN @VP_DIA = '25' THEN ( CASE WHEN DIA_25 = '' OR DIA_25 = @VP_PACKING_NO THEN @VP_PACKING_NO WHEN DIA_25 LIKE '%' + @VP_PACKING_NO + '%' THEN DIA_25 ELSE CONCAT(DIA_25,'/', @VP_PACKING_NO) END) ELSE DIA_25 END ), 
																DIA_26	= 	( CASE WHEN @VP_DIA = '26' THEN ( CASE WHEN DIA_26 = '' OR DIA_26 = @VP_PACKING_NO THEN @VP_PACKING_NO WHEN DIA_26 LIKE '%' + @VP_PACKING_NO + '%' THEN DIA_26 ELSE CONCAT(DIA_26,'/', @VP_PACKING_NO) END) ELSE DIA_26 END ), 
																DIA_27	= 	( CASE WHEN @VP_DIA = '27' THEN ( CASE WHEN DIA_27 = '' OR DIA_27 = @VP_PACKING_NO THEN @VP_PACKING_NO WHEN DIA_27 LIKE '%' + @VP_PACKING_NO + '%' THEN DIA_27 ELSE CONCAT(DIA_27,'/', @VP_PACKING_NO) END) ELSE DIA_27 END ), 
																DIA_28	= 	( CASE WHEN @VP_DIA = '28' THEN ( CASE WHEN DIA_28 = '' OR DIA_28 = @VP_PACKING_NO THEN @VP_PACKING_NO WHEN DIA_28 LIKE '%' + @VP_PACKING_NO + '%' THEN DIA_28 ELSE CONCAT(DIA_28,'/', @VP_PACKING_NO) END) ELSE DIA_28 END ),
																DIA_29	= 	( CASE WHEN @VP_DIA = '29' THEN ( CASE WHEN DIA_29 = '' OR DIA_29 = @VP_PACKING_NO THEN @VP_PACKING_NO WHEN DIA_29 LIKE '%' + @VP_PACKING_NO + '%' THEN DIA_29 ELSE CONCAT(DIA_29,'/', @VP_PACKING_NO) END) ELSE DIA_29 END ), 
																DIA_30	= 	( CASE WHEN @VP_DIA = '30' THEN ( CASE WHEN DIA_30 = '' OR DIA_30 = @VP_PACKING_NO THEN @VP_PACKING_NO WHEN DIA_30 LIKE '%' + @VP_PACKING_NO + '%' THEN DIA_30 ELSE CONCAT(DIA_30,'/', @VP_PACKING_NO) END) ELSE DIA_30 END ),	
																DIA_31	= 	( CASE WHEN @VP_DIA = '31' THEN ( CASE WHEN DIA_31 = '' OR DIA_31 = @VP_PACKING_NO THEN @VP_PACKING_NO WHEN DIA_31 LIKE '%' + @VP_PACKING_NO + '%' THEN DIA_31 ELSE CONCAT(DIA_31,'/', @VP_PACKING_NO) END) ELSE DIA_31 END )
														WHERE CUS_PART_NO = 'PACKING'	
														AND TYPE = @VP_TYPE

														-- UPDATE INVOICE
														UPDATE	@VP_SALIDA_PIEL_MHI_TBL 	
															SET	DIA_1	= 	( CASE WHEN @VP_DIA = '01' THEN ( CASE WHEN DIA_1 = '' OR DIA_1 = @VP_INV_NO THEN @VP_INV_NO WHEN DIA_1 LIKE '%' + @VP_INV_NO + '%' THEN DIA_1 ELSE CONCAT(DIA_1,'/', @VP_INV_NO) END) ELSE DIA_1 END ), 
																DIA_2	= 	( CASE WHEN @VP_DIA = '02' THEN ( CASE WHEN DIA_2 = '' OR DIA_2 = @VP_INV_NO THEN @VP_INV_NO WHEN DIA_2 LIKE '%' + @VP_INV_NO + '%' THEN DIA_2 ELSE CONCAT(DIA_2,'/', @VP_INV_NO) END) ELSE DIA_2 END ),   
																DIA_3	= 	( CASE WHEN @VP_DIA = '03' THEN ( CASE WHEN DIA_3 = '' OR DIA_3 = @VP_INV_NO THEN @VP_INV_NO WHEN DIA_3 LIKE '%' + @VP_INV_NO + '%' THEN DIA_3 ELSE CONCAT(DIA_3,'/', @VP_INV_NO) END) ELSE DIA_3 END ),   
																DIA_4	= 	( CASE WHEN @VP_DIA = '04' THEN ( CASE WHEN DIA_4 = '' OR DIA_4 = @VP_INV_NO THEN @VP_INV_NO WHEN DIA_4 LIKE '%' + @VP_INV_NO + '%' THEN DIA_4 ELSE CONCAT(DIA_4,'/', @VP_INV_NO) END) ELSE DIA_4 END ),   
																DIA_5	= 	( CASE WHEN @VP_DIA = '05' THEN ( CASE WHEN DIA_5 = '' OR DIA_5 = @VP_INV_NO THEN @VP_INV_NO WHEN DIA_5 LIKE '%' + @VP_INV_NO + '%' THEN DIA_5 ELSE CONCAT(DIA_5,'/', @VP_INV_NO) END) ELSE DIA_5 END ),   
																DIA_6	= 	( CASE WHEN @VP_DIA = '06' THEN ( CASE WHEN DIA_6 = '' OR DIA_6 = @VP_INV_NO THEN @VP_INV_NO WHEN DIA_6 LIKE '%' + @VP_INV_NO + '%' THEN DIA_6 ELSE CONCAT(DIA_6,'/', @VP_INV_NO) END) ELSE DIA_6 END ),   
																DIA_7	= 	( CASE WHEN @VP_DIA = '07' THEN ( CASE WHEN DIA_7 = '' OR DIA_7 = @VP_INV_NO THEN @VP_INV_NO WHEN DIA_7 LIKE '%' + @VP_INV_NO + '%' THEN DIA_7 ELSE CONCAT(DIA_7,'/', @VP_INV_NO) END) ELSE DIA_7 END ),   
																DIA_8	= 	( CASE WHEN @VP_DIA = '08' THEN ( CASE WHEN DIA_8 = '' OR DIA_8 = @VP_INV_NO THEN @VP_INV_NO WHEN DIA_8 LIKE '%' + @VP_INV_NO + '%' THEN DIA_8 ELSE CONCAT(DIA_8,'/', @VP_INV_NO) END) ELSE DIA_8 END ),   
																DIA_9	= 	( CASE WHEN @VP_DIA = '09' THEN ( CASE WHEN DIA_9 = '' OR DIA_9 = @VP_INV_NO THEN @VP_INV_NO WHEN DIA_9 LIKE '%' + @VP_INV_NO + '%' THEN DIA_9 ELSE CONCAT(DIA_9,'/', @VP_INV_NO) END) ELSE DIA_9 END ),   
																DIA_10	= 	( CASE WHEN @VP_DIA = '10' THEN ( CASE WHEN DIA_10 = '' OR DIA_10 = @VP_INV_NO THEN @VP_INV_NO WHEN DIA_10 LIKE '%' + @VP_INV_NO + '%' THEN DIA_10 ELSE CONCAT(DIA_10,'/', @VP_INV_NO) END) ELSE DIA_10 END ),	
																DIA_11	= 	( CASE WHEN @VP_DIA = '11' THEN ( CASE WHEN DIA_11 = '' OR DIA_11 = @VP_INV_NO THEN @VP_INV_NO WHEN DIA_11 LIKE '%' + @VP_INV_NO + '%' THEN DIA_11 ELSE CONCAT(DIA_11,'/', @VP_INV_NO) END) ELSE DIA_11 END ),	 
																DIA_12	= 	( CASE WHEN @VP_DIA = '12' THEN ( CASE WHEN DIA_12 = '' OR DIA_12 = @VP_INV_NO THEN @VP_INV_NO WHEN DIA_12 LIKE '%' + @VP_INV_NO + '%' THEN DIA_12 ELSE CONCAT(DIA_12,'/', @VP_INV_NO) END) ELSE DIA_12 END ),	 
																DIA_13	= 	( CASE WHEN @VP_DIA = '13' THEN ( CASE WHEN DIA_13 = '' OR DIA_13 = @VP_INV_NO THEN @VP_INV_NO WHEN DIA_13 LIKE '%' + @VP_INV_NO + '%' THEN DIA_13 ELSE CONCAT(DIA_13,'/', @VP_INV_NO) END) ELSE DIA_13 END ),	 
																DIA_14	= 	( CASE WHEN @VP_DIA = '14' THEN ( CASE WHEN DIA_14 = '' OR DIA_14 = @VP_INV_NO THEN @VP_INV_NO WHEN DIA_14 LIKE '%' + @VP_INV_NO + '%' THEN DIA_14 ELSE CONCAT(DIA_14,'/', @VP_INV_NO) END) ELSE DIA_14 END ),	 
																DIA_15	= 	( CASE WHEN @VP_DIA = '15' THEN ( CASE WHEN DIA_15 = '' OR DIA_15 = @VP_INV_NO THEN @VP_INV_NO WHEN DIA_15 LIKE '%' + @VP_INV_NO + '%' THEN DIA_15 ELSE CONCAT(DIA_15,'/', @VP_INV_NO) END) ELSE DIA_15 END ),	 
																DIA_16	= 	( CASE WHEN @VP_DIA = '16' THEN ( CASE WHEN DIA_16 = '' OR DIA_16 = @VP_INV_NO THEN @VP_INV_NO WHEN DIA_16 LIKE '%' + @VP_INV_NO + '%' THEN DIA_16 ELSE CONCAT(DIA_16,'/', @VP_INV_NO) END) ELSE DIA_16 END ),	 
																DIA_17	= 	( CASE WHEN @VP_DIA = '17' THEN ( CASE WHEN DIA_17 = '' OR DIA_17 = @VP_INV_NO THEN @VP_INV_NO WHEN DIA_17 LIKE '%' + @VP_INV_NO + '%' THEN DIA_17 ELSE CONCAT(DIA_17,'/', @VP_INV_NO) END) ELSE DIA_17 END ),	 
																DIA_18	= 	( CASE WHEN @VP_DIA = '18' THEN ( CASE WHEN DIA_18 = '' OR DIA_18 = @VP_INV_NO THEN @VP_INV_NO WHEN DIA_18 LIKE '%' + @VP_INV_NO + '%' THEN DIA_18 ELSE CONCAT(DIA_18,'/', @VP_INV_NO) END) ELSE DIA_18 END ),	 
																DIA_19	= 	( CASE WHEN @VP_DIA = '19' THEN ( CASE WHEN DIA_19 = '' OR DIA_19 = @VP_INV_NO THEN @VP_INV_NO WHEN DIA_19 LIKE '%' + @VP_INV_NO + '%' THEN DIA_19 ELSE CONCAT(DIA_19,'/', @VP_INV_NO) END) ELSE DIA_19 END ),	 
																DIA_20	= 	( CASE WHEN @VP_DIA = '20' THEN ( CASE WHEN DIA_20 = '' OR DIA_20 = @VP_INV_NO THEN @VP_INV_NO WHEN DIA_20 LIKE '%' + @VP_INV_NO + '%' THEN DIA_20 ELSE CONCAT(DIA_20,'/', @VP_INV_NO) END) ELSE DIA_20 END ),
																DIA_21	= 	( CASE WHEN @VP_DIA = '21' THEN ( CASE WHEN DIA_21 = '' OR DIA_21 = @VP_INV_NO THEN @VP_INV_NO WHEN DIA_21 LIKE '%' + @VP_INV_NO + '%' THEN DIA_21 ELSE CONCAT(DIA_21,'/', @VP_INV_NO) END) ELSE DIA_21 END ), 
																DIA_22	= 	( CASE WHEN @VP_DIA = '22' THEN ( CASE WHEN DIA_22 = '' OR DIA_22 = @VP_INV_NO THEN @VP_INV_NO WHEN DIA_22 LIKE '%' + @VP_INV_NO + '%' THEN DIA_22 ELSE CONCAT(DIA_22,'/', @VP_INV_NO) END) ELSE DIA_22 END ), 
																DIA_23	= 	( CASE WHEN @VP_DIA = '23' THEN ( CASE WHEN DIA_23 = '' OR DIA_23 = @VP_INV_NO THEN @VP_INV_NO WHEN DIA_23 LIKE '%' + @VP_INV_NO + '%' THEN DIA_23 ELSE CONCAT(DIA_23,'/', @VP_INV_NO) END) ELSE DIA_23 END ), 
																DIA_24	= 	( CASE WHEN @VP_DIA = '24' THEN ( CASE WHEN DIA_24 = '' OR DIA_24 = @VP_INV_NO THEN @VP_INV_NO WHEN DIA_24 LIKE '%' + @VP_INV_NO + '%' THEN DIA_24 ELSE CONCAT(DIA_24,'/', @VP_INV_NO) END) ELSE DIA_24 END ), 
																DIA_25	= 	( CASE WHEN @VP_DIA = '25' THEN ( CASE WHEN DIA_25 = '' OR DIA_25 = @VP_INV_NO THEN @VP_INV_NO WHEN DIA_25 LIKE '%' + @VP_INV_NO + '%' THEN DIA_25 ELSE CONCAT(DIA_25,'/', @VP_INV_NO) END) ELSE DIA_25 END ), 
																DIA_26	= 	( CASE WHEN @VP_DIA = '26' THEN ( CASE WHEN DIA_26 = '' OR DIA_26 = @VP_INV_NO THEN @VP_INV_NO WHEN DIA_26 LIKE '%' + @VP_INV_NO + '%' THEN DIA_26 ELSE CONCAT(DIA_26,'/', @VP_INV_NO) END) ELSE DIA_26 END ), 
																DIA_27	= 	( CASE WHEN @VP_DIA = '27' THEN ( CASE WHEN DIA_27 = '' OR DIA_27 = @VP_INV_NO THEN @VP_INV_NO WHEN DIA_27 LIKE '%' + @VP_INV_NO + '%' THEN DIA_27 ELSE CONCAT(DIA_27,'/', @VP_INV_NO) END) ELSE DIA_27 END ), 
																DIA_28	= 	( CASE WHEN @VP_DIA = '28' THEN ( CASE WHEN DIA_28 = '' OR DIA_28 = @VP_INV_NO THEN @VP_INV_NO WHEN DIA_28 LIKE '%' + @VP_INV_NO + '%' THEN DIA_28 ELSE CONCAT(DIA_28,'/', @VP_INV_NO) END) ELSE DIA_28 END ),
																DIA_29	= 	( CASE WHEN @VP_DIA = '29' THEN ( CASE WHEN DIA_29 = '' OR DIA_29 = @VP_INV_NO THEN @VP_INV_NO WHEN DIA_29 LIKE '%' + @VP_INV_NO + '%' THEN DIA_29 ELSE CONCAT(DIA_29,'/', @VP_INV_NO) END) ELSE DIA_29 END ), 
																DIA_30	= 	( CASE WHEN @VP_DIA = '30' THEN ( CASE WHEN DIA_30 = '' OR DIA_30 = @VP_INV_NO THEN @VP_INV_NO WHEN DIA_30 LIKE '%' + @VP_INV_NO + '%' THEN DIA_30 ELSE CONCAT(DIA_30,'/', @VP_INV_NO) END) ELSE DIA_30 END ),	
																DIA_31	= 	( CASE WHEN @VP_DIA = '31' THEN ( CASE WHEN DIA_31 = '' OR DIA_31 = @VP_INV_NO THEN @VP_INV_NO WHEN DIA_31 LIKE '%' + @VP_INV_NO + '%' THEN DIA_31 ELSE CONCAT(DIA_31,'/', @VP_INV_NO) END) ELSE DIA_31 END )
														...
														-- UPDATE AMOUNT
														UPDATE	@VP_SALIDA_PIEL_MHI_TBL 	
															SET	DIA_1	= 	( CASE WHEN @VP_DIA = '01' THEN ( CASE WHEN DIA_1 = '' OR DIA_1 = @VP_AMOUNT THEN @VP_AMOUNT WHEN DIA_1 LIKE '%' + @VP_AMOUNT + '%' THEN DIA_1 ELSE CONCAT(DIA_1,'/', @VP_AMOUNT) END) ELSE DIA_1 END ), 
																DIA_2	= 	( CASE WHEN @VP_DIA = '02' THEN ( CASE WHEN DIA_2 = '' OR DIA_2 = @VP_AMOUNT THEN @VP_AMOUNT WHEN DIA_2 LIKE '%' + @VP_AMOUNT + '%' THEN DIA_2 ELSE CONCAT(DIA_2,'/', @VP_AMOUNT) END) ELSE DIA_2 END ),    
																DIA_3	= 	( CASE WHEN @VP_DIA = '03' THEN ( CASE WHEN DIA_3 = '' OR DIA_3 = @VP_AMOUNT THEN @VP_AMOUNT WHEN DIA_3 LIKE '%' + @VP_AMOUNT + '%' THEN DIA_3 ELSE CONCAT(DIA_3,'/', @VP_AMOUNT) END) ELSE DIA_3 END ),    
																DIA_4	= 	( CASE WHEN @VP_DIA = '04' THEN ( CASE WHEN DIA_4 = '' OR DIA_4 = @VP_AMOUNT THEN @VP_AMOUNT WHEN DIA_4 LIKE '%' + @VP_AMOUNT + '%' THEN DIA_4 ELSE CONCAT(DIA_4,'/', @VP_AMOUNT) END) ELSE DIA_4 END ),    
																DIA_5	= 	( CASE WHEN @VP_DIA = '05' THEN ( CASE WHEN DIA_5 = '' OR DIA_5 = @VP_AMOUNT THEN @VP_AMOUNT WHEN DIA_5 LIKE '%' + @VP_AMOUNT + '%' THEN DIA_5 ELSE CONCAT(DIA_5,'/', @VP_AMOUNT) END) ELSE DIA_5 END ),    
																DIA_6	= 	( CASE WHEN @VP_DIA = '06' THEN ( CASE WHEN DIA_6 = '' OR DIA_6 = @VP_AMOUNT THEN @VP_AMOUNT WHEN DIA_6 LIKE '%' + @VP_AMOUNT + '%' THEN DIA_6 ELSE CONCAT(DIA_6,'/', @VP_AMOUNT) END) ELSE DIA_6 END ),    
																DIA_7	= 	( CASE WHEN @VP_DIA = '07' THEN ( CASE WHEN DIA_7 = '' OR DIA_7 = @VP_AMOUNT THEN @VP_AMOUNT WHEN DIA_7 LIKE '%' + @VP_AMOUNT + '%' THEN DIA_7 ELSE CONCAT(DIA_7,'/', @VP_AMOUNT) END) ELSE DIA_7 END ),    
																DIA_8	= 	( CASE WHEN @VP_DIA = '08' THEN ( CASE WHEN DIA_8 = '' OR DIA_8 = @VP_AMOUNT THEN @VP_AMOUNT WHEN DIA_8 LIKE '%' + @VP_AMOUNT + '%' THEN DIA_8 ELSE CONCAT(DIA_8,'/', @VP_AMOUNT) END) ELSE DIA_8 END ),    
																DIA_9	= 	( CASE WHEN @VP_DIA = '09' THEN ( CASE WHEN DIA_9 = '' OR DIA_9 = @VP_AMOUNT THEN @VP_AMOUNT WHEN DIA_9 LIKE '%' + @VP_AMOUNT + '%' THEN DIA_9 ELSE CONCAT(DIA_9,'/', @VP_AMOUNT) END) ELSE DIA_9 END ),    
																DIA_10	= 	( CASE WHEN @VP_DIA = '10' THEN ( CASE WHEN DIA_10 = '' OR DIA_10 = @VP_AMOUNT THEN @VP_AMOUNT WHEN DIA_10 LIKE '%' + @VP_AMOUNT + '%' THEN DIA_10 ELSE CONCAT(DIA_10,'/', @VP_AMOUNT) END) ELSE DIA_10 END ),	
																DIA_11	= 	( CASE WHEN @VP_DIA = '11' THEN ( CASE WHEN DIA_11 = '' OR DIA_11 = @VP_AMOUNT THEN @VP_AMOUNT WHEN DIA_11 LIKE '%' + @VP_AMOUNT + '%' THEN DIA_11 ELSE CONCAT(DIA_11,'/', @VP_AMOUNT) END) ELSE DIA_11 END ),	 
																DIA_12	= 	( CASE WHEN @VP_DIA = '12' THEN ( CASE WHEN DIA_12 = '' OR DIA_12 = @VP_AMOUNT THEN @VP_AMOUNT WHEN DIA_12 LIKE '%' + @VP_AMOUNT + '%' THEN DIA_12 ELSE CONCAT(DIA_12,'/', @VP_AMOUNT) END) ELSE DIA_12 END ),	 
																DIA_13	= 	( CASE WHEN @VP_DIA = '13' THEN ( CASE WHEN DIA_13 = '' OR DIA_13 = @VP_AMOUNT THEN @VP_AMOUNT WHEN DIA_13 LIKE '%' + @VP_AMOUNT + '%' THEN DIA_13 ELSE CONCAT(DIA_13,'/', @VP_AMOUNT) END) ELSE DIA_13 END ),	 
																DIA_14	= 	( CASE WHEN @VP_DIA = '14' THEN ( CASE WHEN DIA_14 = '' OR DIA_14 = @VP_AMOUNT THEN @VP_AMOUNT WHEN DIA_14 LIKE '%' + @VP_AMOUNT + '%' THEN DIA_14 ELSE CONCAT(DIA_14,'/', @VP_AMOUNT) END) ELSE DIA_14 END ),	 
																DIA_15	= 	( CASE WHEN @VP_DIA = '15' THEN ( CASE WHEN DIA_15 = '' OR DIA_15 = @VP_AMOUNT THEN @VP_AMOUNT WHEN DIA_15 LIKE '%' + @VP_AMOUNT + '%' THEN DIA_15 ELSE CONCAT(DIA_15,'/', @VP_AMOUNT) END) ELSE DIA_15 END ),	 
																DIA_16	= 	( CASE WHEN @VP_DIA = '16' THEN ( CASE WHEN DIA_16 = '' OR DIA_16 = @VP_AMOUNT THEN @VP_AMOUNT WHEN DIA_16 LIKE '%' + @VP_AMOUNT + '%' THEN DIA_16 ELSE CONCAT(DIA_16,'/', @VP_AMOUNT) END) ELSE DIA_16 END ),	 
																DIA_17	= 	( CASE WHEN @VP_DIA = '17' THEN ( CASE WHEN DIA_17 = '' OR DIA_17 = @VP_AMOUNT THEN @VP_AMOUNT WHEN DIA_17 LIKE '%' + @VP_AMOUNT + '%' THEN DIA_17 ELSE CONCAT(DIA_17,'/', @VP_AMOUNT) END) ELSE DIA_17 END ),	 
																DIA_18	= 	( CASE WHEN @VP_DIA = '18' THEN ( CASE WHEN DIA_18 = '' OR DIA_18 = @VP_AMOUNT THEN @VP_AMOUNT WHEN DIA_18 LIKE '%' + @VP_AMOUNT + '%' THEN DIA_18 ELSE CONCAT(DIA_18,'/', @VP_AMOUNT) END) ELSE DIA_18 END ),	 
																DIA_19	= 	( CASE WHEN @VP_DIA = '19' THEN ( CASE WHEN DIA_19 = '' OR DIA_19 = @VP_AMOUNT THEN @VP_AMOUNT WHEN DIA_19 LIKE '%' + @VP_AMOUNT + '%' THEN DIA_19 ELSE CONCAT(DIA_19,'/', @VP_AMOUNT) END) ELSE DIA_19 END ),	 
																DIA_20	= 	( CASE WHEN @VP_DIA = '20' THEN ( CASE WHEN DIA_20 = '' OR DIA_20 = @VP_AMOUNT THEN @VP_AMOUNT WHEN DIA_20 LIKE '%' + @VP_AMOUNT + '%' THEN DIA_20 ELSE CONCAT(DIA_20,'/', @VP_AMOUNT) END) ELSE DIA_20 END ),
																DIA_21	= 	( CASE WHEN @VP_DIA = '21' THEN ( CASE WHEN DIA_21 = '' OR DIA_21 = @VP_AMOUNT THEN @VP_AMOUNT WHEN DIA_21 LIKE '%' + @VP_AMOUNT + '%' THEN DIA_21 ELSE CONCAT(DIA_21,'/', @VP_AMOUNT) END) ELSE DIA_21 END ), 
																DIA_22	= 	( CASE WHEN @VP_DIA = '22' THEN ( CASE WHEN DIA_22 = '' OR DIA_22 = @VP_AMOUNT THEN @VP_AMOUNT WHEN DIA_22 LIKE '%' + @VP_AMOUNT + '%' THEN DIA_22 ELSE CONCAT(DIA_22,'/', @VP_AMOUNT) END) ELSE DIA_22 END ), 
																DIA_23	= 	( CASE WHEN @VP_DIA = '23' THEN ( CASE WHEN DIA_23 = '' OR DIA_23 = @VP_AMOUNT THEN @VP_AMOUNT WHEN DIA_23 LIKE '%' + @VP_AMOUNT + '%' THEN DIA_23 ELSE CONCAT(DIA_23,'/', @VP_AMOUNT) END) ELSE DIA_23 END ), 
																DIA_24	= 	( CASE WHEN @VP_DIA = '24' THEN ( CASE WHEN DIA_24 = '' OR DIA_24 = @VP_AMOUNT THEN @VP_AMOUNT WHEN DIA_24 LIKE '%' + @VP_AMOUNT + '%' THEN DIA_24 ELSE CONCAT(DIA_24,'/', @VP_AMOUNT) END) ELSE DIA_24 END ), 
																DIA_25	= 	( CASE WHEN @VP_DIA = '25' THEN ( CASE WHEN DIA_25 = '' OR DIA_25 = @VP_AMOUNT THEN @VP_AMOUNT WHEN DIA_25 LIKE '%' + @VP_AMOUNT + '%' THEN DIA_25 ELSE CONCAT(DIA_25,'/', @VP_AMOUNT) END) ELSE DIA_25 END ), 
																DIA_26	= 	( CASE WHEN @VP_DIA = '26' THEN ( CASE WHEN DIA_26 = '' OR DIA_26 = @VP_AMOUNT THEN @VP_AMOUNT WHEN DIA_26 LIKE '%' + @VP_AMOUNT + '%' THEN DIA_26 ELSE CONCAT(DIA_26,'/', @VP_AMOUNT) END) ELSE DIA_26 END ), 
																DIA_27	= 	( CASE WHEN @VP_DIA = '27' THEN ( CASE WHEN DIA_27 = '' OR DIA_27 = @VP_AMOUNT THEN @VP_AMOUNT WHEN DIA_27 LIKE '%' + @VP_AMOUNT + '%' THEN DIA_27 ELSE CONCAT(DIA_27,'/', @VP_AMOUNT) END) ELSE DIA_27 END ), 
																DIA_28	= 	( CASE WHEN @VP_DIA = '28' THEN ( CASE WHEN DIA_28 = '' OR DIA_28 = @VP_AMOUNT THEN @VP_AMOUNT WHEN DIA_28 LIKE '%' + @VP_AMOUNT + '%' THEN DIA_28 ELSE CONCAT(DIA_28,'/', @VP_AMOUNT) END) ELSE DIA_28 END ),
																DIA_29	= 	( CASE WHEN @VP_DIA = '29' THEN ( CASE WHEN DIA_29 = '' OR DIA_29 = @VP_AMOUNT THEN @VP_AMOUNT WHEN DIA_29 LIKE '%' + @VP_AMOUNT + '%' THEN DIA_29 ELSE CONCAT(DIA_29,'/', @VP_AMOUNT) END) ELSE DIA_29 END ), 
																DIA_30	= 	( CASE WHEN @VP_DIA = '30' THEN ( CASE WHEN DIA_30 = '' OR DIA_30 = @VP_AMOUNT THEN @VP_AMOUNT WHEN DIA_30 LIKE '%' + @VP_AMOUNT + '%' THEN DIA_30 ELSE CONCAT(DIA_30,'/', @VP_AMOUNT) END) ELSE DIA_30 END ),	
																DIA_31	= 	( CASE WHEN @VP_DIA = '31' THEN ( CASE WHEN DIA_31 = '' OR DIA_31 = @VP_AMOUNT THEN @VP_AMOUNT WHEN DIA_31 LIKE '%' + @VP_AMOUNT + '%' THEN DIA_31 ELSE CONCAT(DIA_31,'/', @VP_AMOUNT) END) ELSE DIA_31 END )
