...
AS
	...
	FOR SELECT	DISTINCT ( CASE WHEN LTRIM(RTRIM(INVENTARIO_EMBARQUE.D_PROD_CAT)) = 'WK-EL RESERVE' THEN 'WK EL RESERVE' 
							...
							ELSE LTRIM(RTRIM(INVENTARIO_EMBARQUE.D_PROD_CAT)) END ), 
	--LTRIM(RTRIM(INVENTARIO_EMBARQUE.D_PROD_CAT)), 
		...
		ORDER BY	--LTRIM(RTRIM(INVENTARIO_EMBARQUE.D_PROD_CAT)), 
					( CASE WHEN LTRIM(RTRIM(INVENTARIO_EMBARQUE.D_PROD_CAT)) = 'WK-EL RESERVE' THEN 'WK EL RESERVE' 
								WHEN LTRIM(RTRIM(INVENTARIO_EMBARQUE.D_PROD_CAT)) = 'WK GLDL' THEN 'WK JEEP GL DL' 
								WHEN LTRIM(RTRIM(INVENTARIO_EMBARQUE.D_PROD_CAT)) = 'WK CJ CAPRI' THEN '2017 WK CJ' 
								WHEN LTRIM(RTRIM(INVENTARIO_EMBARQUE.D_PROD_CAT)) = '2018 WK YL' THEN 'WK YL' 
							ELSE LTRIM(RTRIM(INVENTARIO_EMBARQUE.D_PROD_CAT)) END ),
	...
	--FETCH NEXT FROM CU_SALIDA_MATERIAL_V3 INTO  @VP_TYPE_PRINCIPAL, @VP_CUS_PART_NO_PRINCIPAL		
		...
		BEGIN
			...
			FOR SELECT	 CONVERT(DATE,F_INVENTARIO_EMBARQUE) CDATE, 
						( CASE WHEN LTRIM(RTRIM(INVENTARIO_EMBARQUE.D_PROD_CAT)) = 'WK-EL RESERVE' THEN 'WK EL RESERVE' 
								...
								WHEN LTRIM(RTRIM(INVENTARIO_EMBARQUE.D_PROD_CAT)) = 'WK CJ CAPRI' THEN '2017 WK CJ' 
								WHEN LTRIM(RTRIM(INVENTARIO_EMBARQUE.D_PROD_CAT)) = '2018 WK YL' THEN 'WK YL' 
							ELSE LTRIM(RTRIM(INVENTARIO_EMBARQUE.D_PROD_CAT)) END )  AS PROD_CAT_DESC, 
				...
				GROUP BY	CONVERT(DATE,F_INVENTARIO_EMBARQUE), LTRIM(RTRIM(INVENTARIO_EMBARQUE.ITEM_NO)), LTRIM(RTRIM(INVENTARIO_EMBARQUE.CUS_PART_NO)), 
							...
							ELSE LTRIM(RTRIM(INVENTARIO_EMBARQUE.D_PROD_CAT)) END ), 
							--LTRIM(RTRIM(INVENTARIO_EMBARQUE.D_PROD_CAT)),  
							LTRIM(RTRIM(INVENTARIO_EMBARQUE.PACKING_NO)), 
				...
				BEGIN
					...
					IF @VP_INV_NO <> 'N/F'
						BEGIN
							...
							AND ( CASE WHEN prod_cat = 'WKE' THEN 'WEL'
										WHEN prod_cat = 'PWG' THEN 'WKG' 
