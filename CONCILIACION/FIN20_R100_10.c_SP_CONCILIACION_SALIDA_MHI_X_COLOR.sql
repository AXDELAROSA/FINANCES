...
/* 
 EXEC	[dbo].[PG_PR_CONCILIACION_SALIDA_MATERIAL_X_COLOR] 0,0, '2020/07/01', '2020/07/24', '2015 WK KL', ''
...
AS
	...
	CREATE TABLE #SALIDA_PIEL_MHI_TBL(
			ID				INT	IDENTITY(1,1),
											...
											BEGIN
												...
												ELSE
													BEGIN
														...
														-- INSERT QTY
														INSERT INTO #SALIDA_PIEL_MHI_TBL (PROD_CAT_DESC, TYPE, PART_NO, CUS_PART_NO,	
		...
		SELECT	*
		FROM #SALIDA_PIEL_MHI_TBL AS SALIDA 

		DROP TABLE #SALIDA_PIEL_MHI_TBL
		SET NOCOUNT ON
	-- ////////////////////////////////////////////////
	-- ////////////////////////////////////////////////
GO
