	...
	DECLARE @VP_ENTRADA_PIEL_MHI_TBL AS TABLE(
		...
		IF @VP_N_RESULTADO_BUSQUEDA > 0
			BEGIN
				...
				FETCH NEXT FROM CU_ENTRADA_MATERIAL INTO @VP_TDATE, @VP_TYPE, @VP_COLOR, @VP_CLOT, @VP_PLOT, @VP_STATUS, @VP_PCOLOR, @VP_THIDES, @VP_TAREA, @VP_AVGAREA
							...
							BEGIN
								...
								INSERT INTO @VP_ENTRADA_PIEL_MHI_TBL
									SELECT	@VP_TDATE, @VP_TYPE, @VP_COLOR, 
											...
											@VP_AVGAREA, @VP_STATUS, @VP_PCOLOR
...
GO
/* 
 EXEC	[dbo].[PG_PR_CONCILIACION_SALIDA_MATERIAL] 0,0,   '2020/09/01' , '2020/09/03' 
*/
