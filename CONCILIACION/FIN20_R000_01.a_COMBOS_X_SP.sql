...
/*'2015 WK KL' --
	EXEC	[dbo].[PG_CB_COLOR_X_PROGRAMA] 0,0,	 '2022/03/01' , '2022/03/31' , '2018 JEEP JL'  --'2020/08/01', '2020/08/30', 'WK GLDL'
*/
...
AS
	...
	where LTRIM(RTRIM(prod_cat_desc)) = LTRIM(RTRIM(@PP_PROGRAMA))		-- AX: 20220404, LE AGREGUÉ LOS LTRIM
	AND   L_BORRADO = 0 
	ORDER BY PROD_CAT
...
AS
	...
	IF @PP_L_CON_TODOS = 0
		BEGIN
			...
			AND prod_cat NOT IN ('WKE', 'PWG', 'PWU', 'WYL', 'PWZ')
