...
-- EXECUTE [dbo].[PG_SK_VENDOR] 0,139,380
...
AS
	...
	-- ///////////////////////////////////////////
		...
		SELECT	TOP (1)
				...
				--ISNULL([N_CREDIT_DAYS],'30') AS N_CREDIT_DAYS
				-- =========================
				...
				,
				(CASE	WHEN [POSTAL_CODE]=''	THEN '0'
						WHEN [POSTAL_CODE]=NULL	THEN '0'
						ELSE [POSTAL_CODE] END) AS POSTAL_CODE

--				ISNULL([POSTAL_CODE]		,'0') AS [POSTAL_CODE]		
				,
				(CASE	WHEN [NUMBER_EXTERIOR]=''	THEN '0'
						WHEN [NUMBER_EXTERIOR]=NULL	THEN '0'
						ELSE [NUMBER_EXTERIOR] END) AS NUMBER_EXTERIOR

--				ISNULL([NUMBER_EXTERIOR]	,'0') AS [NUMBER_EXTERIOR]		
...
AS
DECLARE @VP_MENSAJE				VARCHAR(300) = ''
DECLARE @PP_K_ADDRESS_VENDOR			INT
DECLARE @PP_K_CONTACT_VENDOR			INT
BEGIN TRANSACTION 
BEGIN TRY
--/////////////////////////////////////////////////////////////
	IF @VP_MENSAJE=''
	...
	SELECT	@PP_K_ADDRESS_VENDOR=K_ADDRESS_VENDOR,
			@PP_K_CONTACT_VENDOR=K_CONTACT_VENDOR
	FROM	VENDOR
	LEFT JOIN ADDRESS_VENDOR ON VENDOR.K_VENDOR= ADDRESS_VENDOR.K_VENDOR
	LEFT JOIN CONTACT_VENDOR ON VENDOR.K_VENDOR= CONTACT_VENDOR.K_VENDOR
	WHERE VENDOR.K_VENDOR=@PP_K_VENDOR
