...
EXECUTE [dbo].[PG_CI_STATUS_PAID_ORDER] 0, 0, 40, 'PURCHASE PAID CLOSED'	,		'CLPAI', 40, '', 1
GO
-- ===============================================
SET NOCOUNT OFF
-- ===============================================
...
GO
	...
	-- CAMPOS ADICIONALES PARA PAGOS CON DIFERENTE MONEDA A LA QUE SE COMPRÓ EL MATERIAL			--AX: 20201209
ALTER TABLE [dbo].[DETAILS_PAYMENT] 
ADD
	[K_PAGO_DIFERENTE_MONEDA]			[INT] NOT NULL DEFAULT 0,							-- --> ES EL VALOR QUE INDICA QUE SE REALIZO UN PAGO CON DIFERENTE MONEDA.
	[K_PAYMENT_CURRENCY]				[INT] NOT NULL DEFAULT -1,							-- --> TIPO DE MONEDA CUANDO SE REALIZÓ EL PAGO
	[TIPO_CAMBIO]						[DECIMAL](19,4) NOT NULL DEFAULT 0, -- --> TIPO DE CAMBIO CUANDO SE REALIZÓ EL PAGO
	[PAGO_REALIZADO_CONVERTIDO]			[DECIMAL](19,4) NOT NULL DEFAULT 0 -- -->  ES EL TOTAL DE LA ORDEN EN LA MONEDA ORIGINAL POR EL TIPO DE CAMBIO DE LA MONEDA DESTINO
GO
