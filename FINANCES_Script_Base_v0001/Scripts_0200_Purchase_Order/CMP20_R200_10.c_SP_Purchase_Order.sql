...
GO															
--		 EXECUTE [dbo].[PG_LI_APPROVE_FINANCES] 0,57,-1,'2020-08-08' , '2020-09-10'		11		-- FABIOLA
...
GO
-- EXECUTE [dbo].[PG_SK_HEADER_PURCHASE_ORDER] 0,139,1,0
...
GO
-- EXECUTE [dbo].[PG_SK_DETAILS_PURCHASE_ORDER] 0,139,1,0
-- EXECUTE [PG_SK_DETAILS_PURCHASE_ORDER] 0,139,  '12' , '0' 
			...
			SET @PP_VP_K_LIVE = @PP_VP_ULTIMO_REGISTRO + 1
				...
				AND		[K_PO_TEMPORAL]=@PP_K_PO_TEMPORAL
					...
					IF @@ROWCOUNT = 0
						BEGIN
							--RAISERROR (@VP_ERROR_1, 16, 1 ) --MENSAJE - Severity -State.
							SET @VP_MENSAJE='[PO#'+CONVERT(VARCHAR(10),@PP_K_PO_TEMPORAL)+'] Not UPDATE'
							RAISERROR (@VP_MENSAJE, 16, 1 ) --MENSAJE - Severity -State.
						END
				----================================================================
				----================================================================
