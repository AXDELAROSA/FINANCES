...
-- CAMBIO_FIRMA			--WHEN	EN_NUM_DEPT IN (5)			THEN	(11928)			-- MANTENIMIENTO		OMARG	(156)
						...
						WHEN	EN_NUM_DEPT IN (7,12)		THEN	(181)			-- PROYECTOS			OMARD
-- CAMBIO_FIRMA			--WHEN	EN_NUM_DEPT IN (12)			THEN	(181)			-- PROYECTOS			OMARD
-- CAMBIO_FIRMA			--WHEN	EN_NUM_DEPT IN (7)			THEN	(6142)			-- SISTEMAS				RAFAELF	(41)
...
-- CAMBIO_FIRMA		--WHEN	EN_NUM_DEPT IN (12)			THEN	(SELECT CONCAT(EP_NOMBRE,' ',EP_APELLIDO_PATERNO) FROM	HOWE.DBO.VISTA_GAFETES WHERE EN_NUM_DEPT=12 AND EN_SUPERVISOR='GERENTES')					-- PROYECTOS
-- CAMBIO_FIRMA		--WHEN	EN_NUM_DEPT IN (7)			THEN	(SELECT CONCAT(EP_NOMBRE,' ',EP_APELLIDO_PATERNO) FROM	HOWE.DBO.VISTA_GAFETES WHERE EN_NUM_DEPT=7 AND EN_SUPERVISOR='GERENTES')					-- SISTEMAS
...
-- CAMBIO_FIRMA		--WHEN	EN_NUM_DEPT IN (12)			THEN	(181)			-- PROYECTOS
-- CAMBIO_FIRMA		--WHEN	EN_NUM_DEPT IN (7)			THEN	(6142)			-- SISTEMAS
...
-- CAMBIO_FIRMA		--IF @PP_K_USUARIO_ACCION IN (62,44,56,47,42,60,43,44,156)
...
BEGIN TRY
	...
	-- /////////////////////////////////////////////////////////////////////	
		...
		--	SELECT @VP_K_HEADER_PURCHASE_ORDER
