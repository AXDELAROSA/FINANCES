...
-- // A LOS USUARIOS DE PRODUCCIÓN SÓLO SE LES MUESTRA EL VENDOR 383: PARA LA SOLICITUD DE HILOS.
-- //////////////////////////////////////////////////////////////
...
AS
	...
	-- PARA SELECCIONAR LOS PROVEEDORES QUE TIENEN ARTÍCULOS
	...
	BEGIN
		...
		INNER JOIN	VENDOR	ON HEADER_PURCHASE_ORDER.K_VENDOR=VENDOR.K_VENDOR
		WHERE		VENDOR.L_BORRADO=0
	...
	BEGIN
		...
		SELECT		DISTINCT
					...
					VENDOR.L_BORRADO		AS L_DELETED, 
					1						AS L_ACTIVO
		FROM		BACKING_YARDAGE
		INNER JOIN	VENDOR	ON BACKING_YARDAGE.K_VENDOR=VENDOR.K_VENDOR
		WHERE		VENDOR.L_BORRADO=0
